                                ...
                                <span class="abbr">
                                    ...
                                    <span class="auth-show">
                                      <span class="auth-icon auth-icon-v">
                                        ...
                                        <a href="/user/realname/" class="auth-icon-v-link" title="已认证" ></a>
                                      </span>
                    ...
                    <dl>
                        <dt>
                            <div class="Ti change">
                                ...
                                <span class="ju"><%--<a href="/user/payment/" class="Annkeld">充 值</a>--%><% if (CanSettlesInFront) { %><a href="/User/withdrawal/" class="Annkele">提 现</a><% }%></span></span>
                            </div>
                        ...
                        <dd>
                            <ul class="bul Mtop20">
                                <% if (CanSettlesInFront) { %><li><a href="/user/withdrawal/">提现</a></li><% }%>
                            ...
                            <ul class="bul">
                                ...
                                <li class="w"><a href="/user/userrate/index.aspx">商家费率</a></li>
                            </ul>
                        </dd>
                    </dl>
                </div>
