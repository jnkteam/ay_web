...
padding: 2px 20px;
   ...
   <script type="text/javascript">
       ...
       function cleanup() {
           ...
           var sSource = '/user/card/cleanupcardcontent.ashx?t=' + Math.random();
...
$("#ctl00_ContentPlaceHolder1_facevaluelist a").click(function() {
        ...
        $("#channel a").click(function() {
            var value = $(this).attr("name");
            $("#ctl00_ContentPlaceHolder1_g_channelId").val(value);
        });
    });
   
    </script>
<script type="text/javascript" src="/javascript/app_user_common.js"></script>
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 <td valign="top" class="r">
    ...
    <table class="V_tb2">
              ...
              <tr class="td1">
            <th><font style="color:#F00;line-height: 80px;">*</font>选择通道</th>
            <td class="submits" id="channel">
              <a id="link103" runat="server" href="?cid=103" >移动充值卡</a>
	        <a id="link108" runat="server" href="?cid=108" >联通充值卡</a>
	        <a id="link210" runat="server" href="?cid=210" >盛付通卡</a>
	        <a id="link113" runat="server" href="?cid=113" >电信充值卡</a>
		    <a id="link104" runat="server" href="?cid=104" >盛大一卡通</a>
		    <a id="link111" runat="server" href="?cid=111" >完美一卡通</a>
		    <a id="link105" runat="server" href="?cid=105" >巨人(征途)一卡通</a>
			<a id="link106" runat="server" href="?cid=106" >骏网一卡通</a>
			<a id="link110" runat="server" href="?cid=110" >网易一卡通</a>
			<a id="link112" runat="server" href="?cid=112" >搜狐一卡通</a>
			<a id="link107" runat="server" href="?cid=107" >腾讯Q币卡</a>
			<a id="link109" runat="server" href="?cid=109" >久游一卡通</a>
			<a id="link118" runat="server" href="?cid=118" >天下通一卡通</a>
			<a id="link208" runat="server" href="?cid=208" >殴飞一卡通</a>
			<a id="link209" runat="server" href="?cid=209" >天下一卡通专项</a>	
			<a id="link119" runat="server" href="?cid=119" >天宏一卡通</a>
			<a id="link115" runat="server" href="?cid=115" >光宇一卡通</a>
            <a id="link117" runat="server" href="?cid=117" >纵游一卡通</a>
            <a id="link116" runat="server" href="?cid=116" >金山一卡通</a>
			<a id="link200" runat="server" href="?cid=200" >神州行浙江卡</a>
			<a id="link201" runat="server" href="?cid=201" >神州行江苏卡</a>
			<a id="link202" runat="server" href="?cid=202" >神州行辽宁卡</a>
			<a id="link203" runat="server" href="?cid=203" >神州行福建卡</a>
			<a id="link204" runat="server" href="?cid=204" >魔兽卡</a>
			<a id="link205" runat="server" href="?cid=205" >联华卡</a>	
            <a id="link999" runat="server" href="?cid=999" >智能识别充值卡</a>
                  </td>
          </tr>
          <tr class="td1">
            <th><font style="color:#F00;line-height: 80px;">*</font>选择面值</th>
            <td class="submit" id="facevaluelist" runat="server">
               </td>
          </tr>
          <tr class="td1">
