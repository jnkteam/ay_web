                    ...
                    <div class="retrieve-password">
                        ...
                        <form runat="server" class="m-form retrieve-form">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="username" runat="server"  CssClass="form-control" placeholder="请输入您的账号" ></asp:TextBox>
                            </div>
                            <div class="form-group">
                                <label class="control-label">验证码：</label>
                                <div class="captcha-control">
                                    <asp:TextBox ID="imgcode" runat="server"  CssClass="form-control" placeholder="请输入验证码" ></asp:TextBox>
                                    <img  alt="点击刷新验证码" id="captchaImg" data-url="/CodeImage.aspx" src="/CodeImage.aspx"  class="captcha" title="点我换一张" onclick="reloadimage();"/>
                                </div>
                            </div>
                            <div class="btn-group">
                                <asp:Button ID="btnNext" runat="server" CssClass="btn btn-primary" Text="下一步"  OnClick="btnNext_Click" />
                            </div>
                        </form>
                    </div>
                </div>
