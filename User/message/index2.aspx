<%@ Page Language="C#" MasterPageFile="~/User/Site1.Master" AutoEventWireup="True" CodeBehind="index.aspx.cs" Inherits="OriginalStudio.WebUI.User.message.index" Title="收款帐号管理" %>
    ...
    <ul class="tab-head">
      ...
      <asp:Repeater ID="msg_data" runat="server"  onitemdatabound="rptfeedback_ItemDataBound">
        ...
        <tr class="td1 message-tr-item">
          ...
          <td>
          <div class="message-title <%=classa %>">
