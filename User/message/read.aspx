<%@ Page Language="C#" MasterPageFile="~/User/Site1.Master" AutoEventWireup="True" CodeBehind="read.aspx.cs" Inherits="OriginalStudio.WebUI.User.message.read" Title="收款帐号管理" %>
