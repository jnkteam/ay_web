...
DateInput.prototype = {
  build: function() {
    ...
    var yearNav = $('<p class="year_nav">' +
      '<span class="button prev" title="上年">&#171;</span>' +
      ' <span class="year_name"></span> ' +
      '<span class="button next" title="下年">&#187;</span>' +
      '</p>');
    ...
    var tableShell = "<table style=width:230px><thead><tr>";
    $(this.adjustDays(this.short_day_names)).each(function() {
      tableShell += "<th>" + this + "</th>";
    });
    tableShell += "</tr></thead><tbody></tbody></table><!--<div style=margin:6px 0;width:230px>快捷键：上月 - page up <p style=text-indent:48px;>下月 - page down<p style=text-indent:48px;>上年 - Ctrl + page down<p style=text-indent:48px;>下年 - Ctrl + page down</div>-->";
  ...
  dateToString: function(date) {
	...
	if (getDate < 10)
	 getDate = "0" + getDate;
    return date.getFullYear() + "-" + this.short_month_names[date.getMonth()] + "-" + getDate; 
  },
