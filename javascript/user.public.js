...
function loginout() {
    $.dialog({
        ...
        fixed: true,
        ok: function() {
            location.href = "/Merchant/loginout.aspx";
            return false
        },
        cancelVal: '取消',
        cancel: true,
...
function salfReset() {
    $.dialog({
        ...
        fixed: true,
        ok: function() {
            location.href = "/Merchant/modes/index.aspx?resetapikey=1";
            return false
        },
        cancelVal: '取消',
        cancel: true,
...
jQuery(document).ready(function() {
    ...
    $("#form_payaccount button.green").click(function() {
        ...
        $.get("/merchant/ajax/payacct.ashx?t=" + Math.random(), { bankName: bankNameValue, action: actionValue, cardAddr: cardAddrValue, cardId: cardIdValue, recardId: recardIdValue, thiscard: thiscardValue },
    ...
    $("#form_password button.green").click(function() {
        ...
        $("#callinfo").html(ldico + "正在提交请求");
        var r = Math.random();
        $.get("/merchant/ajax/ModiPwd.ashx?r=" + r.toLocaleString(), serializex($("#aspnetForm").serialize()),
        function(data, textStatus) {
            if (data == "true") {
    ...
    $("#form_cover button.green").click(function() {
        ...
        $(this).attr("disabled", true);
        $("#callinfo").html(ldico + "正在提交请求");
        $.get("/merchant/ajax/Cover.ashx", serializex($("#aspnetForm").serialize()),
        function(data, textStatus) {
            if (data == "true") {
    ...
    $("#form_userinfo button.green").click(function() {
        ...
        $("#callinfo").html(ldico + "正在提交请求");
        var r = Math.random();
        $.get("/merchant/ajax/userinfo.ashx?r=" + r.toString(), serializex($("#aspnetForm").serialize()),
        function(data, textStatus) {
            if (data == "true") {
    ...
    $("#form_cashpass button.green").click(function() {
        ...
        $(this).attr("disabled", true);
        $("#callinfo").html(ldico + "正在提交请求");
        $.get("/merchant/ajax/cashpass.ashx", serializex($("#aspnetForm").serialize()),
        function(data, textStatus) {
            if (data == "true") {
    ...
    $("#form_email button.green").click(function() {
        ...
        $("#callinfo").html(ldico + "正在提交请求");
        var r = Math.random();
        $.get("/merchant/ajax/Email.ashx?r=" + r.toString(), serializex($("#aspnetForm").serialize()),
        function(data, textStatus) {
            if (data == "true") {
    ...
    $("#form_person button.green").click(function() {
        ...
        $(this).attr("disabled", true);
        var r = Math.random();
        $.get("/merchant/ajax/DPI.ashx?r=" + r.toString(), serializex($("#aspnetForm").serialize()),
        function(data, textStatus) {
            if (data == "true") {
    ...
    $("#form_person3 button.green").click(function() {
        ...
        $(this).attr("disabled", true);
        $("#callinfo").html(ldico + "正在提交请求");
        $.get("/merchant/ajax/DPI2.ashx", serializex($("#aspnetForm").serialize()),
        function(data, textStatus) {
            if (data == "true") {
    ...
    $("#form_askpay button.green").click(function() {
        ...
        $(this).attr("disabled", true);
        $("#callinfo").html(ldico + "正在提交请求");
        $.get("/merchant/ajax/Askpay.ashx?r=" + Math.random(), serializex($("#aspnetForm").serialize()),
        function(data, textStatus) {
            if (data == "true") {
    ...
    $("#form_askpay #payMoney").blur(function() {
        ...
        $.get("/merchant/ajax/getdaxie.ashx", { payMoney: payMoneyvalue },
        function(data, textStatus) {
            if (data == "true") { } else {
    ...
    $("a#sendmsg").click(function() {
        ...
        $.get("/merchant/ajax/phonevalid.ashx?t=" + Math.random(), serializex($("#aspnetForm").serialize()),
        function(data, textStatus) {
            if (data == "true") {
    ...
    $("a#sendmsgs").click(function() {
        $("#callinfo").html(ldico + "正在发送验证码");
        $.get("/merchant/ajax/SendVerifyCode.ashx?t=" + Math.random(), serializex($("#aspnetForm").serialize()),
        function(data, textStatus) {
            if (data == "true") {
                $("#callinfo").html(okico + "验证码发送成功!")
            } else {
