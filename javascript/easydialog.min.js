    ...
    d.prototype = {
        ...
        createDialogWrap: function(a) {
            ...
            a = [
                    ...
                    a.header ? '<h4 class="easyDialog_title" id="easyDialogTitle"><a href="javascript:void(0)" title="关闭窗口" class="close_btn" id="closeBtn">&times;</a>' + a.header + '</h4>' : '',
                    '<div class="easyDialog_text">' + a.content + '</div>',
                    b === '' && c === '' ? '' : '<div class="easyDialog_footer">' + c + b + '</div>',
                    '</div>'
                ].join('');
            ...
            b.innerHTML = a.replace(/<[\/]*script[\s\S]*?>/gi, '');
            return b
        }
    };
