...
$(function () {
    if ($("#bar-chart")[0]) {
        var sSource = '/user/Service/chartDataSource.ashx?t=' + Math.random();
        var postData = '';
        $.ajax({
            type: "post",
            dataType: "json",
            ...
            success: function (json) {
                if (json.result == 'ok') {
                    ...
                    //alert(qq);
                    //=======================
                    var data1;// = [[1,20], [3,60], [4,40], [5,100], [6,25], [7,65], [8,5], [9,70]];
                    if (wy != "")
                        eval("data1 = " + wy);
                    else
                        data1 = [[1,0]];
                    var data2;// = [[1,20], [3,60], [4,40], [5,100], [6,25], [7,65], [8,5], [9,70]];
                    if (zfb != "")
                        eval("data2 = " + zfb);
                    else
                        data2 = [[1,0]];
                    var data3;  //  = [[1,100], [2,20], [3,60], [4,90], [5,80], [6,10], [7,5],[8,50]];
                    if (wx != "")
                        eval("data3 = " + wx);
                    else
                        data3 = [[1,0]];
                    var data4;  // = [[1,120], [2,60], [3,80], [4,40], [5,50], [6,20], [7,8], [8,35], [9,60], [10,90]];
                    if (qq != "")
                        eval("data4 = " + qq);
                    else
                        data4 = [[1,0]];
