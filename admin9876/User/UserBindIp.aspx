<%@ Page Language="C#" AutoEventWireup="True" Inherits="OriginalStudio.WebUI.Manage.User.UserBindIp" Codebehind="UserBindIp.aspx.cs" %>
          ...
          <tr height="30" >
                        <td>
                            ...
                            <div class="input-group-btn">
                               <button type="button" class="btn btn-primary">IP绑定</button>
                            </div>
                            <asp:TextBox ID="IP" required class="form-control" runat="server"></asp:TextBox>&nbsp;
                             &nbsp;<asp:DropDownList ID="ipType" class="form-control" runat="server">
                                                               <asp:ListItem Value="1">登录验证IP</asp:ListItem>
                                                               <asp:ListItem Value="2">下发API验证IP</asp:ListItem>

                                                           </asp:DropDownList>
                             <asp:Button ID="btnAdd" Class="button btn  btn-danger"  runat="server" Text="绑定" OnClick="btnAdd_Click" ></asp:Button>
                            </div>
                        </td>
                        </tr>
                                                    ...
                                                    <td>
                                                     ...
                                                     <td>
                                                      ...
                                                      <td>
                                                       ...
                                                       <input type="button" class="button btn btn-xs  btn-danger" value="删除" onclick="window.location.href='UserBindIp.aspx?cmd=delete&ipid=<%# Eval("id")%>&userid=<%# Eval("userid")%>'"/>
</td>
                                                </tr>
                                            </ItemTemplate>
