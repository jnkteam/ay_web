<%@ Page Language="C#" AutoEventWireup="True" Inherits="OriginalStudio.WebUI.Manage.Order.BankOrderShow" Codebehind="BankOrderShow.aspx.cs" %>
...
<body>
    ...
    <table cellspacing="0" class="table" cellpadding="0" width="100%" border="0">
        <tr>
            <td class="td2">
                订单编号
            </td>
