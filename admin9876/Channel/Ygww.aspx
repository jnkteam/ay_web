<%@ Page Language="C#" AutoEventWireup="True" Inherits="OriginalStudio.WebUI.Manage.Channel.Ygww" Codebehind="Ygww.aspx.cs" %>
...
<body>
    <form id="Form1" runat="server">
        <table width="100%" border="0" cellpadding="1" cellspacing="1" id="table_zyads" style="width: 100%;
            ...
            <tr>             
                <td align="center">
                    <asp:Button ID="btnGetBalance" runat="server" Text="查询余额" OnClick="btnGetBalance_Click"></asp:Button>
                </td>
            </tr>
        </table>
    </form>
