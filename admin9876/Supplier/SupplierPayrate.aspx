<%@ Page Language="C#" AutoEventWireup="True" validateRequest="false" Inherits="OriginalStudio.WebUI.Manage.Supplier.SupplierPayrate" Codebehind="SupplierPayrate.aspx.cs" %>
                                                                                        ...
                                                                                        <tr height="30">
                                                                                            ...
                                                                                            <td>
                                                                                             ...
                                                                                             <td>
                                                                                                ...
                                                                                                <input style="width: 108px !important;" type="text" value="<%#Eval("rateValue")%>" class="form-control rateInput"  id="rate_<%# Eval("typeid")%>" />%
