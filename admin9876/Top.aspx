          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  <%=username %>
                  <small>上次登录时间：<%=logintime %></small>
                  <small>上次登录IP：<%=loginip %></small>
                </p>
              </li>
              <!-- Menu Body -->
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<%=ADMIN_URI%>/ChangePwd.aspx" class="btn btn-default btn-flat">修改密码</a>
                </div>
                <div class="pull-right">
                  <a href="<%=ADMIN_URI%>/Logout.aspx" class="btn btn-default btn-flat">退出登录</a>
                </div>
              </li>
            </ul>
          </li>
