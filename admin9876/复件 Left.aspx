<%@ Page Language="C#" AutoEventWireup="True" Inherits="OriginalStudio.WebUI.Manage.Left" Codebehind="Left.aspx.cs" %>
...
hr { width:90%; text-align:left; size:0; height:0px; border-top:1px solid #46A0C8;}
    ...
    <script>
        ...
        function clock() {
            ...
            $.ajax({
                type: 'get',
                url: "tools/Supplier.aspx", //实际修改为查询我们数据库里面支付结果记录
...
<audio id="bgMusic" src="/Prompt/4331.aac"  loop="loop"></audio>
            ...
            <tr class="tdbg">
                <td valign="top" class="left_color" id="menubar">
                    <div id="left0" style="display: ">
                        ...
                        <a target="rightframe" href="Newsuser.aspx">开通商户</a>
                        <a target="rightframe" href="Reviewname.aspx">实名审核</a>
                    </div>
                    <div id="left1" style="display: none;">
                        ...
                        <a target="rightframe" href="CahceManage.aspx" >清理系统缓存</a>
                         <a target="rightframe" href="CahceManage.aspx" >网关缓存管理</a>
                    ...
                    <div id="left6" style="display: none">
						...
						<a href="StatCharts/DayOrdersChart.aspx" target="_blank">日成交量统计</a>						
                    </div>                     
                    <div id="left3" style="display: none">
						...
						<a target="rightframe" href="Channel/Ygww.aspx" >阳光万维专用</a>
