<%@ Page Language="C#" AutoEventWireup="True" Inherits="KuaiCard.WebUI.Manage.User.BankForUser" Codebehind="BankForUser.aspx.cs" %>
    ...
    <table width="100%" border="0" cellspacing="1" cellpadding="1" class="table1">
        ...
        <tr>
            <td>
				...
				&nbsp;&nbsp;<span style="color: #ff0000; text-align: left">总余额：<%#TotalMoney%></span>
            </td>
        </tr>
        <tr>
            <td align="center">
