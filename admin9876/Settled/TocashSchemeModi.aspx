<%@ Page Language="C#" AutoEventWireup="True"
    Inherits="KuaiCard.WebUI.Manage.TocashSchemeModi" Codebehind="TocashSchemeModi.aspx.cs" %>
...
<body>
    ...
    <table cellspacing="0" cellpadding="0" width="100%" border="0">
        ...
        <tr>
            ...
            <td class="td1">
                <asp:TextBox ID="txtalipaydetentiondays" runat="server" Width="200px">0</asp:TextBox>
            </td>
        </tr>
         <tr>
            <td class="td2">
            ...
            <td class="td1">
                <asp:TextBox ID="txtweixindetentiondays" runat="server" Width="200px">0</asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="td2">
