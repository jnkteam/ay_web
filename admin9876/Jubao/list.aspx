<%@ Page Language="C#" AutoEventWireup="True" Inherits="KuaiCard.WebUI.Manage.Jubao.List" Codebehind="list.aspx.cs" %>
                    ...
                    <asp:Repeater ID="rptIamges" EnableViewState="false" runat="server" OnItemDataBound="rptUsersItemDataBound">
                        ...
                        <ItemTemplate>
                            <tr style="background-color: #EFF3FB" ondblclick="javascript:sendInfo('<%# Eval("id")%>')">
                                ...
                                <td>
                                    <%# Enum.GetName(typeof(KuaiCard.Model.JuBaoEnum), Eval("type"))%>
                                </td> 
                                <td>
                                     <%# cutword(Eval("remark"))%>
                                </td>   
                                <td>
                                    <%# Enum.GetName(typeof(KuaiCard.Model.JuBaoStatusEnum),Eval("status"))%>
                                </td>
                                <td>
                                    <%# Eval("check")%>
                                </td>
