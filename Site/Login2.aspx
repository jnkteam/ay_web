<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Login2.aspx.cs" Inherits="OriginalStudio.WebUI.User.UserLoginV2" %>
...
<head>
	...
	<script type="text/javascript">
	    function checkInput() {
			 var x = document.getElementById("ayinput");
  
	        if ($("#j_username").val() == "") {
	            alert('账号不能为空');
	            return false;
	        }
			$("#hidPwd").val(x.password);
			if ($("#hidPwd").val() == "") {
	            alert("密码不能为空！");
	            return false;
	        }
    ...
    <div class="mainFixed xs_notice w_of">
        ...
        <div class="t_reg">
            <form id="form1" runat="server">			
				<asp:HiddenField ID="hidPwd" runat="server"></asp:HiddenField>
				<asp:HiddenField ID="hidDesc" runat="server"></asp:HiddenField>
            	<input runat="server" name="j_username" id="j_username" type="text" class="t_input" placeholder="请输入账号" maxlength="50"/>
				<object id="ayinput" classid="CLSID:FBD232C1-F6E5-4A88-AEEC-CF30C84A5847" codebase="getcert.CAB#version=0,0,0,0" width="320" height="40" style="margin-bottom:20px;"></object>
                <div class="of wie">
                    ...
                    <div class="fr"><img  alt="点击刷新验证码" id="captchaImg" data-url="/CodeImage.aspx" src="/CodeImage.aspx"  title="点我换一张" onclick="reloadimage();"/></div>
                </div>
                <asp:Button ID="btnLogin" runat="server" Text="登录" class="t_btnBox f_f f_14" OnClientClick="return checkInput();" />
                <div class="t_text">没有账号？<a href="#.html" class="f_blue f_14">注册</a><a href="#" class="fr">忘记密码</a></div>
            </form>
        </div>
