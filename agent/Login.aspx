<%@ Page Language="C#" AutoEventWireup="True" Inherits="OriginalStudio.WebUI.agent.Login" Codebehind="login.aspx.cs" %>
                ...
                <div class="login_bg">
                    ...
                    <div class="input_pwd">
                        验证码：<input class="colorblur" onblur="this.style;" maxlength="5" size="6" name="CCode"
                            id="CCode" />
                        <img src="/CodeImage.aspx" alt="看不清，点击更换图片。" name="codeimg" width="63" height="22"
