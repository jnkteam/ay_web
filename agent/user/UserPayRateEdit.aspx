<%@ Page Language="C#" AutoEventWireup="True" Inherits="OriginalStudio.web.Agent.User.UserPayRateEdit" CodeBehind="UserPayRateEdit.aspx.cs" %>
...
<body>
    ...
    <table cellspacing="0" cellpadding="0" width="100%" border="0">
            <tr>
                ...
                &nbsp;<asp:Button ID="btnCopy" runat="server" Text="我的费率" 
     ...
     <table cellspacing="0" cellpadding="0" width="100%" border="0">
            ...
            <tr>
                ...
                <td class="td1a">
                    <asp:TextBox ID="txtp1000" runat="server" Width="80px" ReadOnly="true"></asp:TextBox>
                </td>
                <td class="td1a">
                    <asp:TextBox ID="txtp1001" runat="server" Width="80px" ReadOnly="true"></asp:TextBox>
                </td>
                <td class="td2a">
                    支付宝：
                </td>
                <td class="td1a">
                    <asp:TextBox ID="txtp1010" runat="server" Width="80px" ReadOnly="true"></asp:TextBox>
                </td>
                <td class="td1a">
                    <asp:TextBox ID="txtp1011" runat="server" Width="80px" ReadOnly="true"></asp:TextBox>
                </td>
                <td class="td2a">
                    网上银行：
                </td>
                <td class="td1a">
                    <asp:TextBox ID="txtp1020" runat="server" Width="80px" ReadOnly="true"></asp:TextBox>
                </td>
                <td class="td1a">
                    <asp:TextBox ID="txtp1021" runat="server" Width="80px" ReadOnly="true"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="td2a">
            ...
            <tr>
                ...
                <td class="td1a">
                    <asp:TextBox ID="txtp3000" runat="server" Width="80px" ReadOnly="true"></asp:TextBox>
                </td>
                <td class="td1a">
                    <asp:TextBox ID="txtp3001" runat="server" Width="80px" ReadOnly="true"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="td2a">
