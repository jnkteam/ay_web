<%@ Page Language="C#" AutoEventWireup="True" Inherits="OriginalStudio.WebUI.agent.Index" Codebehind="Index.aspx.cs" %>
                    ...
                    <div>
                        <div class="left b_size" style="margin: 1px; width: 99%">
                            <div class="addrtitle f_size">
                                ...
                                <p>
                                <p>
                                    商户今日充值量：<%=todaytotalAmt%>元</p>
                                <p>
                                    商户当月充值量：<%=monthtotalAmt%>元</p>
                                <p>
                                    商户当年充值量：<%=yeartotalAmt%>元</p>
                                <p>
