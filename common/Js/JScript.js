...
function loginout() {
    $.dialog({
        ...
        fixed: true,
        ok: function() {
            location.href = "/user/users/loginout/";
            return false
        },
        cancelVal: '取消',
        cancel: true,
...
jQuery(document).ready(function() {
    ...
    $("#form_payaccount button.green").click(function() {
        ...
        $.get("set/", $("#form_payaccount").serialize(),
    ...
    $("#form_password button.green").click(function() {
        ...
        $(this).attr("disabled", true);
        $("#callinfo").html(ldico + "正在提交请求");
        $.get("set/", $("#form_password").serialize(),
        function(data, textStatus) {
            if (data == "true") {
    ...
    $("#form_userinfo button.green").click(function() {
        ...
        $(this).attr("disabled", true);
        $("#callinfo").html(ldico + "正在提交请求");
        $.get("set/", $("#form_userinfo").serialize(),
        function(data, textStatus) {
            if (data == "true") {
    ...
    $("#form_cashpass button.green").click(function() {
        ...
        $(this).attr("disabled", true);
        $("#callinfo").html(ldico + "正在提交请求");
        $.get("set/", $("#form_cashpass").serialize(),
        function(data, textStatus) {
            if (data == "true") {
    ...
    $("#form_person3 button.green").click(function() {
        ...
        $(this).attr("disabled", true);
        $("#callinfo").html(ldico + "正在提交请求");
        $.get("set/", $("#form_person3").serialize(),
        function(data, textStatus) {
            if (data == "true") {
                $("#form_person3").submit()
            } else {
    ...
    $("a#sendmsg").click(function() {
        ...
        $.get("set/?send=msg", $("#form_userinfo").serialize(),
        function(data, textStatus) {
            if (data == "true") {
