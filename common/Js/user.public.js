...
function loginout() {
    $.dialog({
        ...
        fixed: true,
        ok: function() {
            location.href = "/user/loginout.aspx";
            return false
        },
        cancelVal: '取消',
        cancel: true,
...
function salfReset() {
    $.dialog({
        ...
        fixed: true,
        ok: function() {
            location.href = "/user/modes/index.aspx?resetapikey=1";
            return false
        },
        cancelVal: '取消',
        cancel: true,
...
//        };
        ...
        $.get("/user/payaccountajax.ashx", $("#aspnetForm").serialize(),
        function(data, textStatus) {
            if (data == "true") {
                ...
                $(".required").val("");
                $("#callinfo").html(okico + "操作成功!请等待管理员审核!")
            } else {
                $("#form_payaccount button.green").removeAttr("disabled");
                $("#callinfo").css({
                    color: "red"
    ...
    $("#form_password button.green").click(function() {
        ...
        $("#callinfo").html(ldico + "正在提交请求");
        var r = Math.random();
        $.get("/user/safe/passwordajax.ashx?r=" + r.toLocaleString(), $("#aspnetForm").serialize(),
        function(data, textStatus) {
            if (data == "true") {
    ...
    $("#form_cover button.green").click(function() {
        ...
        $(this).attr("disabled", true);
        $("#callinfo").html(ldico + "正在提交请求");
        $.get("/user/safe/coverajax.ashx", $("#aspnetForm").serialize(),
        function(data, textStatus) {
            if (data == "true") {
    ...
    $("#form_userinfo button.green").click(function() {
        ...
        $("#callinfo").html(ldico + "正在提交请求");
        var r = Math.random();
        $.get("/user/userinfoajax.ashx?r=" + r.toString(), $("#aspnetForm").serialize(),
        function(data, textStatus) {
            if (data == "true") {
    ...
    $("#form_cashpass button.green").click(function() {
        ...
        $(this).attr("disabled", true);
        $("#callinfo").html(ldico + "正在提交请求");
        $.get("/user/safe/cashpassajax.ashx", $("#aspnetForm").serialize(),
        function(data, textStatus) {
            if (data == "true") {
    ...
    $("#form_Paidverify button.green").click(function() {
        if ($("#loginpass").val() == '') {
            $("#loginpass").focus();
            $("#callinfo").html(errico + "请输入您的登录密码，以便验证身份");
            return false
    ...
    $("#form_email button.green").click(function() {
        ...
        $("#callinfo").html(ldico + "正在提交请求");
        var r = Math.random();
        $.get("/user/safe/emailajax.ashx?r=" + r.toString(), $("#aspnetForm").serialize(),
        function(data, textStatus) {
            if (data == "true") {
    ...
    $("#form_person button.green").click(function() {
        ...
        $(this).attr("disabled", true);
        var r = Math.random();
        $.get("/user/safe/trnaajax.ashx?r=" + r.toString(), $("#aspnetForm").serialize(),
        function(data, textStatus) {
            if (data == "true") {
    ...
    $("#form_person3 button.green").click(function() {
        ...
        $(this).attr("disabled", true);
        $("#callinfo").html(ldico + "正在提交请求");
        $.get("/user/safe/trna2ajax.ashx", $("#aspnetForm").serialize(),
        function(data, textStatus) {
            if (data == "true") {
    ...
    $("#form_askpay button.green").click(function() {
        ...
        $(this).attr("disabled", true);
        $("#callinfo").html(ldico + "正在提交请求");
        $.get("/user/avail/askpayajax.ashx?r="+Math.random(), $("#aspnetForm").serialize(),
        function(data, textStatus) {
            if (data == "true") {
    ...
    $("#form_askpay #payMoney").blur(function() {
        ...
        $.get("/user/avail/getdaxie.ashx", $("#aspnetForm").serialize(),
        function(data, textStatus) {
            if (data == "true") { } else {
    ...
    $("a#sendmsg").click(function() {
        ...
        $.get("/user/phonevalid.ashx", $("#aspnetForm").serialize(),
        function(data, textStatus) {
            if (data == "true") {
