<%@ Page Language="C#" AutoEventWireup="True" Inherits="KuaiCard.WebUI.Manage.ManageEdit" Codebehind="ManageEdit.aspx.cs" %>
...
<body>    
    ...
    <table cellspacing="0" cellpadding="0" width="100%" border="0">
        ...
        <tr>
            ...
            <td class="td1">
                <asp:TextBox ID="tel" runat="server" Width="200px"></asp:TextBox>
            </td>
        </tr>
