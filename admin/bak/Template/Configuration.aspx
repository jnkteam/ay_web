<%@ Page Language="C#" AutoEventWireup="True" Inherits="OriginalStudio.WebUI.Manage.Template.Configuration" Codebehind="Configuration.aspx.cs" %>
    ...
    <table width="100%" border="0" cellspacing="1" cellpadding="3">
            ...
            <tr>
                <td class="td2">
                    提现财务提醒：</td>
                <td class="td1" colspan="3">
                    <asp:TextBox ID="Textamount" runat="server" Width="800px">尊敬的陛下您好，商户{@username}，申请一笔清算，金额为【@amount】元。请您及时处理。【@sitename】</asp:TextBox></td>
            </tr>
            <tr>
                <td class="td2">
                    提现财务提醒：</td>
                <td class="td1" colspan="3">
                    <asp:TextBox ID="Textamount2" runat="server" Width="800px">尊敬的陛下，商户{@username}，申请一笔委托清算，请您及时处理。【@sitename】</asp:TextBox></td>
            </tr>
            <tr>
                <td>
                    &nbsp;</td>
