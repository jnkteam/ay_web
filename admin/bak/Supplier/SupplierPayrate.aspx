<%@ Page Language="C#" AutoEventWireup="True" Inherits="KuaiCard.WebUI.Manage.SupplierPayrate" Codebehind="SupplierPayrate.aspx.cs" %>
            ...
            <table cellspacing="0" cellpadding="0" width="100%" border="0">                
                ...
                <tr class="card" style="display:none">
                    <td class="td2">
                        支付宝APP：</td>
                    <td class="td1">
                        <asp:TextBox ID="txtp980" runat="server" Width="200px"></asp:TextBox>
                    </td>
                </tr>
                <tr class="card" style="display:none">
                    <td class="td2">
                ...
                <tr class="card" style="display:none">
                    <td class="td2">
                        微信APP：</td>
                    <td class="td1">
                        <asp:TextBox ID="txtp990" runat="server" Width="200px"></asp:TextBox>
                    </td>
                </tr>
                <tr class="card" >
                    <td class="td2">
                ...
                <tr class="card" style="display:none">
                    <td class="td2">
                        京东：</td>
                    <td class="td1">
                        <asp:TextBox ID="txtp300" runat="server" Width="200px"></asp:TextBox>
                    </td>
                </tr>					
                <tr class="card" style="display:none">
                    <td class="td2">
                        网银APP：</td>
                    <td class="td1">
                        <asp:TextBox ID="txtp1020" runat="server" Width="200px"></asp:TextBox>
                    </td>
                </tr>
