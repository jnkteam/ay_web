                ...
                <td align="center">
                    <table width="100%" id="tab" border="0" align="center" cellpadding="2" cellspacing="1">
                        <asp:Repeater ID="rptUsers" EnableViewState="false" runat="server" OnItemDataBound="rptUsersItemDataBound">
                            <HeaderTemplate>
                                <tr height="30" style="background-color: #507CD1; color: #fff; height: 22;">
                                    <td>
                            ...
                            <ItemTemplate>
                                <tr height="30" style="background-color: #EFF3FB">
                                    <td>
                                    ...
                                    <td><a href="UserChannel.aspx?ID=<%# Eval("id")%>">通 道<%#isSpecialChannel(Eval("ID"))%></a></td>
                                    <td><a href="UserPayRateEdit.aspx?ID=<%# Eval("id")%>">费率</a></td>
                                    <td>
                                        <asp:Label ID="labcmd" runat="server"></asp:Label>
                                        <a href="javascript:sendMsg(<%# Eval("ID") %>);">发信息</a>
										<a href="UserInfoPrint.aspx?ID=<%# Eval("ID") %>" target="_blank" >打印</a>
									</td>
                            ...
                            <AlternatingItemTemplate>
                                <tr height="30" style="background-color: #ffffff">
                                    <td>
                                        <input id="chkItem" type="checkbox" value='<%#Eval("id")%>' name="chkItem" />
                                    </td>
                                     <td>
                                    ...
                                    <td>
                                     ...
                                     <td><a href="UserPayRateEdit.aspx?ID=<%# Eval("id")%>">
                                            费率</a></td>
                                    <td>
                                        <asp:Label ID="labcmd" runat="server"></asp:Label>
                                        <a href="javascript:sendMsg(<%# Eval("ID") %>);">发信息</a>
										<a href="UserInfoPrint.aspx?ID=<%# Eval("ID") %>" target="_blank" >打印</a></td>
                                    </td>
									<td>
                                        <%# Eval("desc")%>
                                    </td>									
