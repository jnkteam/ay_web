<%@ Page Language="C#" AutoEventWireup="True" Inherits="KuaiCard.WebUI.Manage.User.UserPayRateEdit" CodeBehind="UserPayRateEdit.aspx.cs" %>
...
<body>
    ...
    <table cellspacing="0" cellpadding="0" width="100%" border="0">
            ...
            <tr>
                ...
                <td class="td1a">
                    <asp:TextBox ID="txtp1020" runat="server" Width="80px"></asp:TextBox>
                </td>				
                <td class="td2a">
                    支付宝扫码：
                </td>
                ...
                <td class="td1a">
                    <asp:TextBox ID="txtp980" runat="server" Width="80px"></asp:TextBox>
                </td>			
            </tr>
            <tr>              
                <td class="td2a">
                ...
                <td class="td1a">
                    <asp:TextBox ID="txtp990" runat="server" Width="80px"></asp:TextBox>
                </td>
                <td class="td2a">
                    QQ钱包：
                </td>
