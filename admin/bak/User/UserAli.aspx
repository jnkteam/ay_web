<%@ Page Language="C#" AutoEventWireup="True" Inherits="OriginalStudio.WebUI.Manage.User.UserAli" Codebehind="UserAli.aspx.cs" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <table cellspacing="0" cellpadding="0" width="100%" border="0">
            ...
            <tr>
                <td class="td2"><span class="style5"> 支付宝账户：</span></td>
                <td class="td1">
                 <asp:TextBox ID="txtZfb" runat="server" Width="200px">0</asp:TextBox></td>
            </tr>
            <tr>
                <td class="td2">分成系数：</td>
                <td class="td1">
                    <asp:TextBox ID="txtZfbf" runat="server" Width="200px"></asp:TextBox>
                </td>
            </tr>            
            <tr>
