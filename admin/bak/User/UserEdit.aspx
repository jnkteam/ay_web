<%@ Page Language="C#" AutoEventWireup="True" Inherits="OriginalStudio.WebUI.Manage.User.UserEdits" Codebehind="UserEdit.aspx.cs" %>
        ...
        <table cellspacing="0" cellpadding="0" width="100%" border="0">
            ...
            <tr>
                <td class="td2">
                    结算途径 ：</td>
                <td class="td1">
					<asp:DropDownList ID="ddlsettles_type" runat="server" Width="150px">
                ...
                <td class="td2">
                    订单标题 ：</td>
                <td class="td1">
					<asp:DropDownList ID="ddlrandom_subject" runat="server" Width="150px">
			...
			<tr>
                 <td class="td2">
                    服务商通道：</td>
                <td class="td1">
                    <asp:RadioButtonList ID="rblservice_channel" Width="130" RepeatLayout="Flow" runat="server" RepeatDirection="Horizontal" AutoPostBack="true" onselectedindexchanged="rblservice_channel_SelectedIndexChanged">
            ...
            <tr>
                <td class="td2">
                    通道限额设置：</td>
                <td class="td1">
					网银: <asp:TextBox ID="txtbank_limit" runat="server" Width="55px" value="0"></asp:TextBox>
					微信: <asp:TextBox ID="txtweixin_limit" runat="server" Width="55px" value="0"></asp:TextBox>
					支付宝: <asp:TextBox ID="txtali_limit" runat="server" Width="55px" value="0"></asp:TextBox>
					QQ钱包: <asp:TextBox ID="txtqq_limit" runat="server" Width="55px" value="0"></asp:TextBox>
                </td>
            </tr>				
            <tr>
                <td class="td2">
