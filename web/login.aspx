...
<div class="new-login-bg">
        ...
        <form id="form1" method="post" action="/web/LoginOn">
            <div class="in-login-con">
                ...
                <div class="dlk-box">
                    ...
                    <span class="yzm">
                        <img id='imgValidateCode' src="/CodeImage.aspx" width="98" height="30" onclick="this.src='/web/getCode?' + Math.random()" /></span>
                </div>
                <div class="wjmi-zc">
    ...
    <div class="bottom-box2">
        ...
        <div class="bottom-2">
            <ul>
                <li><a href="http://www.anquan.org/authenticate/cert/?site=www.0n2.com&amp;at=business" target="_blank">
                ...
                <li><a href="https://credit.szfw.org/CX20151120012380180199.html" target="_blank">
