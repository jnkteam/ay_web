...
<html>
<head>
    <title>爱扬网络企业资质_游戏点卡回收_API消耗接口_游戏支付平台接口提供商</title>
...
<link type="text/css" rel="stylesheet" href="../Content/Web/style/baguettebox.min.css">
<link type="text/css" rel="stylesheet" href="../Content/Web/style/lrtk.css">
<script type="text/javascript" src="../Content/Web/js/baguettebox.min.js"></script>
<script type="text/javascript" src="../Content/Web/js/jquery.min.js"></script>
<script type="text/javascript" src="../Content/Web/js/jquery.smoove.js"></script>
<script type="text/javascript" src="../Content/Web/js/jquery-1.11.1.min.js"></script>
<script type="text/javascript" src="../Content/Web/js/jquery-ui.min.js"></script>

<div class="banner8-box">
    <div class="banner8-con">
        <img src="../Content/Web/images/08_1.png">
    </div>
</div>

<div class="platform-con">
    <!-- 公司资质 -->
    <div class="baguetteBoxOne gallery" style="margin-top: 50px;">
        <a class="a5" href="../Content/Web/images/1-5.jpg"></a>
        <a class="a7" href="../Content/Web/images/1-7.jpg"></a>
        <a class="a3" href="../Content/Web/images/1-3.jpg"></a>
        <a class="a2" href="../Content/Web/images/1-2.jpg"></a>
        <a class="a4" href="../Content/Web/images/1-4.jpg"></a>
        <a class="a8" href="../Content/Web/images/1-8.jpg"></a>
    </div>
    <script>
        ...
        <div class="bottom">
            ...
            <div class="guanzhu">
                <div class="guanzhu-txt">
                    爱扬网络：WwW.0N2.Com是国内领先的充值卡收购平台<br>
    ...
    <div class="footer-box2">
        <div class="footer">
            <span>Copyright  &copy; 2015 爱扬网络 WwW.0N2.Com鲁ICP备16036145号 网络文化经营许可证号:鲁网文〔2016〕5998-043号</span>
            <div>
